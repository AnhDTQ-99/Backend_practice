...
public class Main {
    public static void main(String[] args) {
        ...
        // 1. Tạo nhân viên Văn Phòng (đã có trong đề bài)
        // (ID, Tên, Địa chỉ, SĐT, Số ngày làm việc)
        EmployeeOffice empOffice = new EmployeeOffice("VP001", "Nguyen Van A", "Ha Noi", 987654321, 22);
        System.out.println("--- Nhân viên Văn Phòng ---");
        empOffice.display();

        // 2. Tạo nhân viên Kỹ Thuật (Vừa tạo ở trên)
        // (ID, Tên, Địa chỉ, SĐT, Số dự án)
        EmployeeTechnical empTech = new EmployeeTechnical("KT002", "Tran Thi B", "Da Nang", 912345678, 3);
        System.out.println("--- Nhân viên Kỹ Thuật ---");
        empTech.display();

        // 3. Tạo nhân viên Bán Hàng (Vừa tạo ở trên)
        // (ID, Tên, Địa chỉ, SĐT, Doanh số)
        EmployeeSales empSale = new EmployeeSales("BH003", "Le Van C", "Ho Chi Minh", 998877665, 50000000);
